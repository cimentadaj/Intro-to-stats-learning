...
```
In this scenarion, although not perfectly depicted, the MSE of the flexible model is better than the linear model, even when applying the model in a subset of the training data.
